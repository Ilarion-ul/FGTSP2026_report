...
\IfFileExists{images/ADScore.jpg}{
  \includegraphics[width=\linewidth,height=0.33\textheight,keepaspectratio]{images/ADScore.jpg}
}{
...
Koning, A. J., Rochman, D., Sublet, J.-C., Dzysiuk, N., Fleming, M., \& van der Marck, S. (2019).
\newblock \textit{TENDL-2019: TALYS-based evaluated nuclear data library}.
\newblock Nuclear Research and Consultancy Group (NRG).

\bibitem[National Science Center Kharkiv Institute of Physics and Technology(2004)]{nsc-kipt-brochure-2004}
National Science Center ``Kharkiv Institute of Physics and Technology'' (2004).
\newblock \textit{Nuclear facility ``Neutron source based on a subcritical assembly driven by an electron accelerator''} [Brochure].

\bibitem[Vodin et~al.(2013)]{vodin2013nsc}
