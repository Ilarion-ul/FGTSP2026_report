...
{\scriptsize \textit{Source:} National Science Center ``Kharkiv Institute of Physics and Technology''. (2004). \textit{Nuclear facility ``Neutron source based on a subcritical assembly driven by an electron accelerator''} [Brochure].}
\end{column}
\end{columns}
\end{frame}
...
\IfFileExists{images/photonuclear_spectrum_1.png}{
  \includegraphics[width=\linewidth,height=0.19\textheight,keepaspectratio]{images/photonuclear_spectrum_1.png}
}{
  \fbox{\parbox[c][0.16\textheight][c]{0.94\linewidth}{\centering Placeholder: photonuclear spectrum (I)}}
}

\IfFileExists{images/photonuclear_spectrum_2.png}{
  \includegraphics[width=\linewidth,height=0.19\textheight,keepaspectratio]{images/photonuclear_spectrum_2.png}
}{
  \fbox{\parbox[c][0.16\textheight][c]{0.94\linewidth}{\centering Placeholder: photonuclear spectrum (II)}}
}

{\scriptsize \textit{Source:} Koning, A. J., Rochman, D., Sublet, J.-C., Dzysiuk, N., Fleming, M., \& van der Marck, S. (2019). \textit{TENDL-2019: TALYS-based evaluated nuclear data library}. NRG.}
\end{column}
\end{columns}
\end{frame}
...
\IfFileExists{images/ADScore.jpg}{
  \includegraphics[width=\linewidth,height=0.18\textheight,keepaspectratio]{images/ADScore.jpg}
}{
  \fbox{\parbox[c][0.15\textheight][c]{0.94\linewidth}{\centering Placeholder: subcritical assembly model image}}
}

\IfFileExists{images/target2.jpg}{
  \includegraphics[width=\linewidth,height=0.18\textheight,keepaspectratio]{images/target2.jpg}
}{
  \fbox{\parbox[c][0.15\textheight][c]{0.94\linewidth}{\centering Placeholder: subcritical assembly detail image}}
}

{\scriptsize \textit{Caption:} 3D Subcritical assembly model.}

{\scriptsize \textit{Source:} Vodin, A. N., Demchenko, P. A., Zelinsky, A. Yu., et al. (2013). \textit{NSC KIPT neutron source status}. \textit{Problems of Atomic Science and Technology}, 88(6), 3--9.}
\end{column}
\end{columns}
\end{frame}
...
\IfFileExists{images/Acselerator Blueprint.png}{
  \includegraphics[width=\linewidth,height=0.42\textheight,keepaspectratio]{images/Acselerator Blueprint.png}
}{
  \fbox{\parbox[c][0.30\textheight][c]{0.94\linewidth}{\centering Placeholder: accelerator blueprint}}
}

{\scriptsize \textit{Caption:} Layout of linac and subcritical assembly.}
...
\hline
n\_primary\_electrons & 1.0e7 & 1.0e7 \\
photons\_above5MeV\_per\_electron\_from\_run\_summary & 3.72338 & 3.92482 \\
neutrons\_per\_electron\_from\_run\_summary & 0.0302579 & 0.0585394 \\
neutrons\_model\_exit\_per\_electron\_from\_run\_summary & 0.0220162 & 0.0444019 \\
Neutron flux at model exit, n/s ($\times N_e/s$) & 1.3740e14 & 2.7716e14 \\
Reference neutron flux (placeholder) & --- & ---
\end{tabular}
\end{center}
\tiny Source: own Geant4 simulation results (run summaries and normalization $N_e/s = 6.24151\times10^{15}$).
\end{frame}
