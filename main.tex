...
\newcommand{\WTaDir}{Data/20260211_172835_W-Ta}
...
\small
\begin{center}
\fbox{\parbox[c][0.34\textheight][c]{0.86\linewidth}{\centering Placeholder: single animation of beam--target interaction\\(sequence of PNG frames will be inserted here)}}
\end{center}
\vspace{-0.2em}
\begin{center}
\footnotesize Figure: dynamic evolution of beam energy deposition and neutron generation.
\end{center}
...
\IfFileExists{\WTaDir/plate_neutron_heatmap_1.png}{
  \animategraphics[loop,autoplay,width=0.48\linewidth]{8}{\WTaDir/plate_neutron_heatmap_}{1}{7}
}{
...
\IfFileExists{\UMoDir/plate_neutron_heatmap_1.png}{
  \animategraphics[loop,autoplay,width=0.48\linewidth]{8}{\UMoDir/plate_neutron_heatmap_}{1}{12}
}{
