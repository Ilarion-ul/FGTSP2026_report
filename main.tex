...
\begin{itemize}
  \item 7 square W plates; active cross-section: \SI{65.8x65.8}{mm} (\(\sim\)\SI{66x66}{mm} with cladding).
  \item Plate thickness profile (mm): 2.5, 2.5, 2.47, 3.53, 3.58, 5.55, 9.5.
  \item Ta cladding: \(\sim\)0.25--0.27 mm with Ti interlayer: 30--40 \(\mu\)m.
  \item Inter-plate water gaps: 1.75--2.0 mm.
  \item SAV-1 Al-alloy square housing: inner \SI{66x66}{mm}, wall \SI{2}{mm}.
\end{itemize}
\end{column}
\begin{column}{0.49\textwidth}
...
\begin{itemize}
  ...
  \end{itemize}
  \item Cladding \(\sim\)0.7--1.0 mm (design/manufacturing dependent).
  \item Variable cooling gaps: 1.0, 1.75, and 3.0 mm.
  \item Integral neutron yield reference: \(3.28\times10^{14}\) n/s.
\end{itemize}
\end{column}
\end{columns}

\vspace{0.2em}
\footnotesize Common elements: \textbf{2 mm Al entrance window} and \textbf{237 mm He chamber} behind the plate stack to displace water and increase useful neutron flux to the subcritical zone.
\end{frame}
