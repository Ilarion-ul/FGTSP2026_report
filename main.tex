...
\IfFileExists{generated_gifs/beam_visualization_W-Ta.gif}{
  ...
  \fbox{\parbox[c][0.28\textheight][c]{0.46\linewidth}{\centering Placeholder: interaction animation (W-Ta)}}
}
\hfill
\IfFileExists{generated_gifs/beam_visualization_U-Mo.gif}{
  ...
  \fbox{\parbox[c][0.28\textheight][c]{0.46\linewidth}{\centering Placeholder: interaction animation (U-Mo)}}
}
\end{center}
\vspace{-0.2em}
\begin{center}
...
\IfFileExists{generated_gifs/plate_neutron_heatmap_W-Ta.gif}{
  ...
  \fbox{\parbox[c][0.28\textheight][c]{0.46\linewidth}{\centering Placeholder: heatmap animation (W-Ta)}}
}
\hfill
\IfFileExists{generated_gifs/plate_neutron_heatmap_U-Mo.gif}{
  ...
  \fbox{\parbox[c][0.28\textheight][c]{0.46\linewidth}{\centering Placeholder: heatmap animation (U-Mo)}}
}
\end{center}
\vspace{-0.2em}
\begin{center}
