...
\begin{figure}
\centering
\IfFileExists{images/nsc_kipt_facility_model.png}{
  \includegraphics[width=0.76\linewidth]{images/nsc_kipt_facility_model.png}
}{
...
\begin{figure}
\centering
\IfFileExists{images/nsc_kipt_facility_photo.png}{
  \includegraphics[width=0.86\linewidth]{images/nsc_kipt_facility_photo.png}
}{
...
\begin{figure}
\centering
\IfFileExists{images/subcritical_assembly_model.png}{
  \includegraphics[width=0.72\linewidth]{images/subcritical_assembly_model.png}
}{
...
\small
\begin{center}
\IfFileExists{generated_gifs/beam_visualization_W-Ta_000.png}{
  \animategraphics[loop,autoplay,width=0.48\linewidth]{12}{generated_gifs/beam_visualization_W-Ta_}{000}{008}
}{
  \fbox{\parbox[c][0.28\textheight][c]{0.46\linewidth}{\centering Placeholder: frame sequence\\beam\_visualization\_W-Ta\_000...008}}
}
\hfill
\IfFileExists{generated_gifs/beam_visualization_U-Mo_000.png}{
  \animategraphics[loop,autoplay,width=0.48\linewidth]{12}{generated_gifs/beam_visualization_U-Mo_}{000}{008}
}{
  \fbox{\parbox[c][0.28\textheight][c]{0.46\linewidth}{\centering Placeholder: frame sequence\\beam\_visualization\_U-Mo\_000...008}}
}
\end{center}
\vspace{-0.2em}
\begin{center}
\footnotesize Figure: comparative beam-interaction evolution in two target designs.
\end{center}
...
\hline
Neutron yield (track-based) & 0.00798 & 0.02669 \\
Photon yield (track-based) & 0.6728 & 1.6825 \\
Neutron boundary output & 0.02196 & 0.04418 \\
High-energy photon indicator & 3.7238 & 3.9245
\end{tabular}
\end{center}
\tiny Source: own Geant4 simulation results and benchmark-oriented comparison practice.
\end{frame}
...
\small
\begin{center}
\IfFileExists{Data/20260211_172835_W-Ta/plate_neutron_heatmap_1.png}{
  \animategraphics[loop,autoplay,width=0.48\linewidth]{8}{Data/20260211_172835_W-Ta/plate_neutron_heatmap_}{1}{7}
}{
  \fbox{\parbox[c][0.28\textheight][c]{0.46\linewidth}{\centering Placeholder: heatmap frame sequence (W-Ta)}}
}
\hfill
\IfFileExists{Data/20260212_072836_U-Mo/plate_neutron_heatmap_1.png}{
  \animategraphics[loop,autoplay,width=0.48\linewidth]{8}{Data/20260212_072836_U-Mo/plate_neutron_heatmap_}{1}{12}
}{
