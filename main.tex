...
\end{itemize}
\vspace{0.1em}
{\footnotesize\begin{tabular}{@{}p{0.54\linewidth}p{0.40\linewidth}@{}}
Beam energy & 100 MeV \\
...
\IfFileExists{images/Acselerator Blueprint.png}{
  \includegraphics[width=\linewidth,height=0.36\textheight,keepaspectratio]{images/Acselerator Blueprint.png}
}{
